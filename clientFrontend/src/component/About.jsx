...
export default function About() {
  return <main className="about-page container">
    <header className="about-heading"><span className="eyebrow">Our marketplace</span><h1>Technology discovery,<br />made for Ethiopia.</h1><p>ElectraMarket helps people find electronics, understand each listing, and connect directly with product owners.</p></header>
    <div className="about-grid">
      ...
      <section><h2>Built for clear connections</h2><p>ElectraMarket is a non-transactional listing platform. We provide product information, owner contact details, community likes and comments, and shareable links. Buyers and owners arrange any transaction independently.</p><div className="about-benefits">{benefits.map(([Icon, text]) => <div key={text}><span><Icon size={19} /></span><strong>{text}</strong></div>)}</div><h2>Our vision</h2><p>To become Ethiopia’s clearest technology discovery marketplace—where anyone can browse, compare, share, and connect with confidence.</p></section>
    </div>
  </main>;
}
